...
- [What's the difference between a variable that is: `null`, `undefined` or `undeclared`?](#what's-the-difference-between-a-variable-that-is:-`null`,-`undefined`-or-`undeclared`?)
